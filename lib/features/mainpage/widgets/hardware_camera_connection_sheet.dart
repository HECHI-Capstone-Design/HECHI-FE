...
class HardwareCameraConnectionSheet extends GetView<HardwareCameraController> {
  const HardwareCameraConnectionSheet({super.key});
        ...
        child: Obx(
          () => Column(
            ...
            children: [
              ...
              if (controller.uploadServerActive.value &&
                  controller.uploadServerUrl.value != null) ...[
                ...
                Container(
                  ...
                  child: Text(
                    "업로드 서버: ${controller.uploadServerUrl.value}",
                    style: const TextStyle(
                      fontSize: 12,
                      color: Color(0xFF666666),
                    ),
                ...
                children: [
                  Expanded(
                    child: OutlinedButton.icon(
                      ...
                      icon: Icon(
                        controller.isScanning ? Icons.stop : Icons.search,
                      ),
              ...
              if (controller.discoveredDevices.isEmpty)
                const Padding(
                  ...
                  child: Text(
                    "아직 찾은 기기가 없어요. 카메라 전원을 켠 뒤 기기 찾기를 눌러주세요.",
                    style: TextStyle(
                      fontSize: 13,
              ...
              if (controller.lastCaptureId.value != null) ...[
                const SizedBox(height: 16),
                Container(
                  width: double.infinity,
                  ...
                  child: Text(
                    "최근 촬영 ID: ${controller.lastCaptureId.value}",
                    style: const TextStyle(
                      fontSize: 13,
...
class _ConnectionStatusCard extends StatelessWidget {
  ...
  final HardwareCameraController controller;
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(
        children: [
          Icon(
            connected ? Icons.photo_camera : Icons.photo_camera_back_outlined,
            color: connected
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  connected
                      ? (controller.connectedDeviceName.value ?? "하이라이트 카메라")
                      : "연결된 카메라 없음",
                  style: const TextStyle(
                    fontSize: 14,
                ...
                Text(
                  connected
                      ? (controller.cameraIp.value?.isNotEmpty == true
                            ? "Wi‑Fi IP: ${controller.cameraIp.value}"
                            : (controller.connectedDeviceId.value ?? ""))
                      : "기기 찾기를 눌러 카메라를 연결할 수 있어요.",
                  style: const TextStyle(
                    fontSize: 12,
                    color: Color(0xFF666666),
                  ),
